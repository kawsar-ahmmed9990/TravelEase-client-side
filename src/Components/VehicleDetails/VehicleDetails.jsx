...
const VehicleDetails = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      <div className="bg-white dark:bg-gray-800 shadow-2xl rounded-3xl overflow-hidden flex flex-col md:flex-row transition-all duration-300 hover:shadow-blue-200">
        {/* Vehicle Image */}
            ...
            <button
              ...
              className={`w-full py-3 rounded-xl font-semibold transition duration-300 ${
                vehicle.availability === "Booked"
                  ...
                  : "bg-[#22c55e] hover:bg-green-700 text-white dark:text-gray-100"
              }`}
            >
              {loading
                ? "Booking..."
